...
//	private static final Logger logger = LogManager.getLogger(GUIAddCAMCommand.class);
	...
	public GUIAddCAMCommand(BlockingQueue<String> commandQueue, final String clientName) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!textFieldCellID.getText().isEmpty()) {
					...
					if (particleList != null) {
						int xOffset = (Integer) spinnerImageDimX.getValue() / 2;
						int yOffset = (Integer) spinnerImageDimY.getValue() / 2;
