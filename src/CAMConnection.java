...
public class CAMConnection {
	...
	//private static final Logger logger = LogManager.getLogger(CAMConnection.class);
	...
	public void connect(InetAddress host, int port) 
	{
		try {
			...
			//logger.trace("Connection to CAM established.");
			
		} catch (IOException e) {
			//logger.error("Connection to CAM failed! "+e.getMessage());
	...
	public void disconnect() {
		if (!(clientSocket == null)) {
			try {
				...
				System.out.println("Connection to CAM closed successfully");
			} catch (IOException e) {
				//logger.error("Failed to close socket: "+ e.getMessage());
				System.out.println("Failed to close socket: " + e.getMessage());
			} catch (InterruptedException e) {
				//logger.error("Disconnect interrupted while waiting for send-/receive threads to finish: " + e.getMessage());
	...
	public void sendCAMCommand(String command) {
		try {
			...
			//logger.error("Interrupted while sending CAM command: " + command + "\n> Error: " + e.getMessage() + " <");
		...
		public void run() {
			...
			while (sendRecvThreadsShouldRun) {
				try {
					...
					System.out.println("Interrupted sending CAM command: "+e.getMessage());
				} 
			}
		}
	}
		...
		public void run() {
			...
			while (sendRecvThreadsShouldRun) {
				try {
					...
					//logger.error("Error during receiving CAM command: "+e.getMessage());
				}
			}
		}
	}
